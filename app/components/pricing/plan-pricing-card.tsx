    ...
    >
      ...
      <div className="mt-auto pt-6">
        <Link
          to={ctaHref}
          className={cn(
            "inline-flex h-12 w-full items-center justify-center rounded-xl border text-base font-semibold transition-colors",
            highlight
              ? "border-transparent bg-primary text-white hover:bg-blue-700 hover:text-white"
              : "border-primary/30 bg-card text-primary hover:bg-primary/5 hover:text-primary",
          )}
        >
          {ctaLabel}
        </Link>
